...
if parameters.USE_SAVED_GRAPH:
	...
	while nodeGenerationCounter < parameters.NETWORK_SIZE: 
		xCoord = -1
		yCoord = -1
		randomForGraphAssign = random.uniform(0, 1)
		# do not use this
		if randomForGraphAssign < 0.125:
			xCoord = -2999 # random.uniform(-3000, -2900)
			yCoord = -2999 # random.uniform(-3000, -2900)
		elif randomForGraphAssign < 0.25:
			xCoord = 2999 # random.uniform(-3000, -2900)
			yCoord = 2999 # random.uniform(-3000, -2900)
		elif randomForGraphAssign < 0.375:
			xCoord = 2999 # random.uniform(-3000, -2900)
			yCoord = -2999 # random.uniform(-3000, -2900)
		elif randomForGraphAssign < 0.5:
			xCoord = -2999 # random.uniform(-3000, -2900)
			yCoord = 2999 # random.uniform(-3000, -2900)
		elif randomForGraphAssign < 0.625:
			xCoord = -1000 # random.uniform(-3000, -2900)
			yCoord = -1000 # random.uniform(-3000, -2900)
		elif randomForGraphAssign < 0.75:
			xCoord = 1000 # random.uniform(-3000, -2900)
			yCoord = 1000 # random.uniform(-3000, -2900)
		elif randomForGraphAssign < 0.875:
			xCoord = 1000 # random.uniform(-3000, -2900)
			yCoord = -1000 # random.uniform(-3000, -2900)
		else:
			xCoord = -1000 # random.uniform(-3000, -2900)
	...
	nx.write_gpickle(G,'Sep17Graph_SimpleTwoBlobs8.gpickle')
...
for line in srcDestPairLines:
	...
	f = open("PathTestVanillaSep17_TwoBlobs8.txt", "a")
		...
		while len(bucketsToRunRL) > 0:
			...
			while RLLoopNodeCounter < parameters.NETWORK_SIZE:
				if len(G.nodes[RLLoopNodeCounter]['RLTables'][currentBucketIndex][parameters.REINFORCEMENT_LEARNING_TABLE_DEST_COLUMN_INDEX]) >= parameters.EPOCH_QUERIES_NUMBER:
					...
					# 	f = open("../../../GitHubExperimentsResults/TestResultAug14_2048_Vanilla_DHT.txt", "a")
