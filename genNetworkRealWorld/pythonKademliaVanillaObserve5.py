...
while True:
	...
	# 	f = open("../../../GitHubExperimentsResults/TestResultSep5_2048_Vanilla_10NL_TestLatency.txt", "a")
	# 	f1 = open("../../../GitHubExperimentsResults/TestResultSep5_2048_Vanilla_10NL_TestNodeLatency.txt", "a")
				...
				if len(G.nodes[RLLoopNodeCounter]['RLTables'][currentBucketIndex][parameters.REINFORCEMENT_LEARNING_TABLE_DEST_COLUMN_INDEX]) >= parameters.EPOCH_QUERIES_NUMBER:
					...
					if RLLoopNodeCounter in observationNodes and currentBucketIndex == 0:
						...
						if RLLoopNodeCounter == 123:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_Vanilla_Observe5_NDRW_C2_123.txt", "a")
						elif RLLoopNodeCounter == 645:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_Vanilla_Observe5_NDRW_C2_645.txt", "a")
						elif RLLoopNodeCounter == 1008:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_Vanilla_Observe5_NDRW_C2_1008.txt", "a")
						elif RLLoopNodeCounter == 1394:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_Vanilla_Observe5_NDRW_C2_1394.txt", "a")
						elif RLLoopNodeCounter == 1877:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_Vanilla_Observe5_NDRW_C2_1877.txt", "a")
