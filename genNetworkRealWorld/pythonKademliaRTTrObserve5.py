...
while True:
	...
	# 	f = open("../../../GitHubExperimentsResults/TestResultSep5_2048_RTTR1R2_Simple_10NL_TestLatency.txt", "a")
	# 	f1 = open("../../../GitHubExperimentsResults/TestResultSep5_2048_RTTR1R2_Simple_10NL_TestNodeLatency.txt", "a")
				...
				if len(G.nodes[RLLoopNodeCounter]['RLTables'][currentBucketIndex][parameters.REINFORCEMENT_LEARNING_TABLE_DEST_COLUMN_INDEX]) >= parameters.EPOCH_QUERIES_NUMBER:
					...
					if G.nodes[RLLoopNodeCounter]['prevScores'][currentBucketIndex] > 0: # not first epoch
						...
						if currentBucketScore * dynamicCP > G.nodes[RLLoopNodeCounter]['prevScores'][currentBucketIndex] and G.nodes[RLLoopNodeCounter]['bucketChangeItemFlags'][currentBucketIndex] == False: # roll back when new epoch performs badly
							...
							G.nodes[RLLoopNodeCounter]['bucketChangeItemFlags'][currentBucketIndex] = True
						elif currentBucketScore * dynamicCP <= G.nodes[RLLoopNodeCounter]['prevScores'][currentBucketIndex] and G.nodes[RLLoopNodeCounter]['bucketChangeItemFlags'][currentBucketIndex]: # change
							...
							while len(bucketItemCandidate_str) < parameters.NODE_ID_LENGTH:
								...
								if len(bucketItemCandidate_str) == parameters.NODE_ID_LENGTH:
									currentRTT = G[RLLoopNodeCounter][bucketOperations.binaryToDecimal(int(bucketItemCandidate_str))]['weight']
					...
					if RLLoopNodeCounter in observationNodes and currentBucketIndex == 0:
						...
						if RLLoopNodeCounter == 123:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_RTTR_Observe5_NDRW_C2_123.txt", "a")
						elif RLLoopNodeCounter == 645:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_RTTR_Observe5_NDRW_C2_645.txt", "a")
						elif RLLoopNodeCounter == 1008:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_RTTR_Observe5_NDRW_C2_1008.txt", "a")
						elif RLLoopNodeCounter == 1394:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_RTTR_Observe5_NDRW_C2_1394.txt", "a")
						elif RLLoopNodeCounter == 1877:
							f = open("../../../GitHubExperimentsResults/TestResultOct8_RTTR_Observe5_NDRW_C2_1877.txt", "a")
