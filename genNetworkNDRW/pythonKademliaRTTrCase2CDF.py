...
import parametersCase2CDF as parameters 
import math
import time
...
srcDestPairFile = open('lookupSrcDestPairs20PercentHot.txt', 'r')
srcDestPairLines = srcDestPairFile.readlines()

for line in srcDestPairLines:
	experimentCounter1 += 1
	print(experimentCounter1)
	...
	f = open("CDFOct17_Case2_RTTR.txt", "a")
	...
	f.write(str(min(lookupResult[0])) + "\n")
	# sumNodeLatency = 0
